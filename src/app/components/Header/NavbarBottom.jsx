        ...
        <Flex className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full px-4 pb-4 lg:pb-0 h-full lg:h-24">
          ...
          >
            ...
            {show && (
              ...
              >
                <li className="shopLink">Clothing</li>
                <li className="shopLink">Footwears</li>
                <li className="shopLink">Accessories</li>
              </motion.ul>
            )}
          </div>
          ...
          <div className="flex gap-4 mt-2 lg:mt-0 items-center pr-6 cursor-pointer relative p-4">
            ...
            {showUser && (
              ...
              >
                {session ? (
                  <>
                    <li className="shopLink">{session.user.name}</li>
                    <li className="shopLink">{session.user.email}</li>

...
export const paginationItems = [
  
    {
      ...
      price: "14,500",
      images:[
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Nike1front.jpg?raw=true",
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Nike1back.jpg?raw=true"
      ],
      main_des:"A plain tshirt, an essential wardrobe staple. Crafted from soft cotton, it offers versatile styling options, from layering to standalone wear, ensuring both comfort and timeless simplicity in every outfit.",
      sex:"Man/Male/Boy or Woman/Female/Girl "
    },
  
    {
      ...
      category: "clothing",
      brand:"nike",
      title: "Air Cotton Long Sleeve Graphic Tee Shirt",
  ...
  
    {
      ...
      category: "clothing",
      brand:"nike",
      title: "Nike Dri-FIT Fast vest",
      description: "Men's trail running tank",
      price: "7,500",
      images:[
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Nvest1front.jpg?raw=true",
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Nvest1back.jpg?raw=true"
      ],
      main_des:"Take your run off the beaten path to new horizons in this lightweight tank. We used trail running insights and incorporated sweat-wicking tech to help you stay cool on both short off-road jogs and longer forest treks. An easy fit through the body and hips gives you a relaxed feel so you can stay focused on your stride.",
      sex:"Man/Male/Boy"
    },
    {
      id: "vest2",
      category: "clothing",
      brand:"nike",
      title: "Nike Dri-FIT ADV AeroSwift vest",
      description: "Women's trail running tank",
      price: "8,500",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Nvest2front.jpg?raw=true",
      "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Nvest2back.jpg?raw=true"
      ],
      main_des:"Navigate the changing seasons in a layer designed with tricky in-between temps in mind. Made from fleece that has a woolly feel, this gilet easily layers over tees or under your favourite jacket. Plus, side pockets give you space to stash all the essentials you might need on your next outdoor adventure.",
      sex:"Woman/Female/Girl"
    },
    ...
    
    {
      ...
      category: "clothing",
      brand:"nike",
      title: "Nike Challenger sports bra",
    ...
    
    {
      ...
      category: "clothing",
      brand:"nike",
      title: "Men's Poly-Knit Tracksuit",
      description: "Nike Sportswear Sport Essentials",
      price: "23,000",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/NTs1front.jpg?raw=true",
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/NTs1back.jpg?raw=true"
      ],
    ...
    
    {
      ...
      price: "11,000",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Ntskids1front.jpg?raw=true",
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Ntskids1back.jpg?raw=true"
      ],
      main_des:"Thinking about what to wear in the morning shouldn't be hard. The Nike Air tracksuit makes it super-easy with a jacket and trousers combo. Wear it together, or mix and match with your other favourites—and done! The pieces are made from lightweight nylon, just like throwback tracksuits from back in the day.",
      sex:"kids"
    },
    
    {
      ...
      description: "Women's Oversized Nike Sportswear Phoenix Fleece  ",
      price: "9,000",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/nHo1front.jpg?raw=true",
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/nHo1back.jpg?raw=true"
      ],
    ...
    // Adidas
    {
      ...
      main_des:"A plain t-shirt, an essential wardrobe staple. Crafted from soft cotton, it offers versatile styling options, from layering to standalone wear, ensuring both comfort and timeless simplicity in every outfit.",
       sex:"Man/Male/Boy or Woman/Female/Girl "
    },
  ...
  
    {
      ...
      images:[
        ...
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/adVe1back.jpg?raw=true"
      ],
      main_des:"Take your run off the beaten path to new horizons in this lightweight tank. We used trail running insights and incorporated sweat-wicking tech to help you stay cool on both short off-road jogs and longer forest treks. An easy fit through the body and hips gives you a relaxed feel so you can stay focused on your stride.",
      sex:"Man/Male/Boy"
    },
    {
      ...
      category: "clothing",
      brand:"adidas",
      title: "Men's trail vest",
      description: "ADV AeroSwift",
      price: "8,500",
    ...
    
    {
      ...
      category: "clothing",
      brand:"adidas",
      title: " Dri AeroSwift shorts",
      description: "Comfortable Shorts",
      price: "8,500",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/adShorts2front.jpg?raw=true",
      "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/adShortts2back.jpg?raw=true"
      ],
    ...
    
    {
      ...
      category: "clothing",
      brand:"adidas",
      title: "Adidas Women's baggy Trouser",
      description: " Sportswear Club Fleece",
      price: "14,500",
  ...
  
    {
      ...
      category: "clothing",
      brand:"adidas",
      title: "Adi Men's Cargo Trousers ",
      description: "Sportswear Club Fleece",
      price: "17,500",
    ...
    
    {
      ...
      category: "clothing",
      brand:"adidas",
      title: "Adilane Men's Poly-Knit Tracksuit",
      description: "Sportswear Sport Essentials",
      price: "23,000",
    ...
    
    {
      ...
      description: " Adilette Fit",
      price: "11,000",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/adTs2front.jpg?raw=true",
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/adTs2back.jpg?raw=true"
      ],
      main_des:"Thinking about what to wear in the morning shouldn't be hard. The Nike Air tracksuit makes it super-easy with a jacket and trousers combo. Wear it together, or mix and match with your other favourites—and done! The pieces are made from lightweight nylon, just like throwback tracksuits from back in the day.",
      sex:"kids"
    },
    
    {
      ...
      description: " Sportswear Phoenix Fleece ",
      price: "9,000",
...

    {
      ...
      category: "clothing",
      brand:"adidas",
      title: " Sportswear Phoenix Fleece HOodie",
     ...
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/adHo2back.jpg?raw=true"
      ],
      main_des:"Rise up and transform your fleece wardrobe with strong cosy vibes. This Phoenix Fleece hoodie's spacious fit keeps you relaxed and comfy while exaggerated details (like extra-tall ribbing and an oversized front pocket) add a bold look, helping you to stand out.",
      sex:"Man/Male/Boy"
    },
    ...
    // puma
    {
      ...
      price: "14,500",
      images:[
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/puShirt2front.jpg?raw=true",
        "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/puShirt2back.jpg?raw=true"
      ],
      main_des:"A plain t-shirt, an essential wardrobe staple. Crafted from soft cotton, it offers versatile styling options, from layering to standalone wear, ensuring both comfort and timeless simplicity in every outfit.",
       sex:"Man/Male/Boy or Woman/Female/Girl "
    },
    ...
    "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/puShirt3back.jpg?raw=true"],
    main_des:"Stay cool and dry in this Nike round neck shirt. Designed with moisture-wicking technology, it effortlessly manages sweat. Breathable fabric ensures comfort, making it ideal for workouts or casual wear.",
     sex:"Man/Male/Boy or Woman/Female/Girl "
    },
...

    {
      ...
      category: "clothing",
      brand:"puma",
      title: "Puma Challenger Sports bra",
      description: "Women's Sports Bra",
      price: "9,000",
    ...
    
    {
      ...
      category: "clothing",
      brand:"puma",
      title: " Fleece baggy trousers",
      description: " Puma Sportswear Club Women's baggy Trouser",
      price: "14,500",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Npants1front.jpg?raw=true",
      "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Npants1back.jpg?raw=true"
    ],
  ...
  
    {
      ...
      description: "Puma Sportswear Club Fleece",
      price: "17,500",
      images:["https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Npants2front.jpg?raw=true",
      "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/Npants2back.jpg?raw=true"
      ],
    ...
    
    {
      ...
      category: "clothing",
      brand:"puma",
      title: "Puma Sportswear  Essentials Tracksuit",
    ...
    
    {
     ...
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/puTr2back.jpg?raw=true"
      ],
      main_des:"Thinking about what to wear in the morning shouldn't be hard. The Nike Air tracksuit makes it super-easy with a jacket and trousers combo. Wear it together, or mix and match with your other favourites—and done! The pieces are made from lightweight nylon, just like throwback tracksuits from back in the day.",
      sex:"kids"
    },
    
    {
     ...
     "https://github.com/Gee051/CapstoneFrontendImages/blob/main/Clothings/puHo1back.jpg?raw=true"
      ],
      main_des:"Rise up and transform your fleece wardrobe with strong cosy vibes. This Phoenix Fleece hoodie's spacious fit keeps you relaxed and comfy while exaggerated details (like extra-tall ribbing and an oversized front pocket) add a bold look, helping you to stand out.",
      sex:"Man/Male/Boy"
    },

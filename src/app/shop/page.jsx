...
const Shop = () => {
  ...
  return (
    <div>
      ...
      <motion.h1
            className="text-5xl py-3 font-extrabold responsive-text"
            initial="hidden"
            animate="visible"
        ...
        <div className="flex items-center ">
          <label
            ...
            className="mr-2 p-2 font-bold responsive-label"
          >
            Products per Page:
          </label>
          <select
            ...
            className="p-2 border border-gray-300 rounded-md responsive-select"
          >
      ...
      {!showMenu && (
        <div className="w-full font-bold text-lg gap-3">
          ...
          <Swiper spaceBetween={20} slidesPerView={slidesPerView}>
            {/* All */}
            <SwiperSlide>
              <button className="px-2" onClick={() => setSelectedCategory("All")}>
                All
              </button>
            </SwiperSlide>
            ...
            {/* Footwear */}
            <SwiperSlide>
              <button className="pl-3" onClick={() => setSelectedCategory("footwear")}>
                Footwear
              </button>
            </SwiperSlide>
            ...
            {/* Accessories */}
            <SwiperSlide>
              <button className="pl-3" onClick={() => setSelectedCategory("accessories")}>
                Accessories
              </button>
            </SwiperSlide>
            ...
            {/* Nike */}
            <SwiperSlide>
              <button className="pl-7" onClick={() => setSelectedBrand("nike")}>
                Nike
              </button>
            </SwiperSlide>
            ...
            {/* Adidas */}
            <SwiperSlide>
              <button className="pl-3" onClick={() => setSelectedBrand("adidas")}>
                Adidas
              </button>
            </SwiperSlide>
            ...
            {/* Puma */}
            <SwiperSlide>
              <button className="pl-3" onClick={() => setSelectedBrand("puma")}>
                Puma
              </button>
            </SwiperSlide>
            ...
            {/* Price Low to High */}
            <SwiperSlide>
              <button className="pl-3" onClick={() => handleSortByClick("lowToHigh")}>
                Price Low to High
              </button>
            </SwiperSlide>
            ...
            {/* Price High to Low */}
            <SwiperSlide>
              <button className="pl-3" onClick={() => handleSortByClick("highToLow")}>
                Price High to Low
              </button>
            </SwiperSlide>
          </Swiper>
              ...
              <ul>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedCategory === "All" ? "font-bold" : ""}`}
                  >
                    All
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedCategory === "clothing" ? "font-bold" : ""}`}
                  >
                    Clothing
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedCategory === "footwear" ? "font-bold" : ""}`}
                  >
                    Footwear
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedCategory === "accessories" ? "font-bold" : ""}`}
                  >
                    Accessories
                  </button>
                </li>
              ...
              <ul>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedBrand === "All" ? "font-bold" : ""}`}
                  >
                    All
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedBrand === "nike" ? "font-bold" : ""}`}
                  >
                    Nike
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedBrand === "adidas" ? "font-bold" : ""}`}
                  >
                    Adidas
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${selectedBrand === "puma" ? "font-bold" : ""}`}
                  >
                    Puma
                  </button>
                </li>
              ...
              <ul>
                <li>
                  <button
                    ...
                    className={`shopBy ${sortBy === "lowToHigh" ? "font-bold" : ""}`}
                  >
                    Low to High
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className={`shopBy ${sortBy === "highToLow" ? "font-bold" : ""}`}
                  >
                    High to Low
                  </button>
                </li>
